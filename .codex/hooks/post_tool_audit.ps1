...
function Write-ActivityLog {
    ...
    try {
        ...
        Write-HookWarning "[zombie-hook] PostToolUse activity logging skipped: $($_.Exception.Message)"
    }
}
...
try {
    ...
    Write-HookWarning "[zombie-hook] PostToolUse audit skipped: $($_.Exception.Message)"
}
